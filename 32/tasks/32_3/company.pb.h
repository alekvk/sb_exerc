...
/* @@protoc_insertion_point(class_definition:Company) */ {
 ...
 public:
  ...
  void set_allocated_typeactivity(std::string* value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::ArenaStringPtr typeactivity_;
    ::int32_t year_;
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void Company::set_typeactivity(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.typeactivity_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:Company.typeActivity)
}
inline std::string* Company::mutable_typeactivity() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void Company::_internal_set_typeactivity(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.typeactivity_.Set(value, GetArena());
}
inline std::string* Company::_internal_mutable_typeactivity() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000004u;
  return _impl_.typeactivity_.Mutable( GetArena());
}
inline std::string* Company::release_typeactivity() {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString()) {
    _impl_.typeactivity_.Set("", GetArena());
  }
  return released;
}
inline void Company::set_allocated_typeactivity(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000004u;
  } else {
  ...
  _impl_.typeactivity_.SetAllocated(value, GetArena());
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.typeactivity_.IsDefault()) {
    _impl_.typeactivity_.Set("", GetArena());
  }
