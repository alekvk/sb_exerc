...
const char descriptor_table_protodef_company_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "\014typeActivity\030\004 \001(\t\022\037\n\027foreignEconomicAc"
    "tivity\030\005 \001(\010"
};
...
inline PROTOBUF_NDEBUG_INLINE Company::Impl_::Impl_(
    ...
    const Impl_& from, const ::Company& from_msg)
      : _has_bits_{from._has_bits_},
        ...
        typeactivity_(arena, from.typeactivity_) {}
...
inline void Company::SharedDtor(MessageLite& self) {
  ...
  this_._impl_.typeactivity_.Destroy();
  this_._impl_.~Impl_();
}
...
const ::_pbi::TcParseTable<3, 5, 0, 45, 2> Company::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(Company, _impl_._has_bits_),
    0, // no _extensions_
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Company, _impl_.year_), 3>(),
     {8, 3, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.year_)}},
    ...
    {::_pbi::TcParser::FastSS1,
     {34, 2, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.typeactivity_)}},
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kRawString | ::_fl::kRepAString)},
    // optional string typeActivity = 4;
    {PROTOBUF_FIELD_OFFSET(Company, _impl_.typeactivity_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kRawString | ::_fl::kRepAString)},
    // optional bool foreignEconomicActivity = 5;
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* Company::_InternalSerialize(
          ...
          // optional string typeActivity = 4;
          if (cached_has_bits & 0x00000004u) {
            const std::string& _s = this_._internal_typeactivity();
            ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(_s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormat::SERIALIZE,
...
void Company::InternalSwap(Company* PROTOBUF_RESTRICT other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.typeactivity_, &other->_impl_.typeactivity_, arena);
